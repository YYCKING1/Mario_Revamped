...
function game(){
  ...
  //characters_environment.js file contains code for controlling mario via keyboard keys but we want to control the mario by nose movements.
//Therefore it is very important that we can access noseX and noseY
//variables inside characters_environment.js file
...
function changeGameStatud(character){
 if(noseX !="" && gameConfig.status==="start" && GameStatus=="start") { 
   ...
   world_start.play();//play the music file
